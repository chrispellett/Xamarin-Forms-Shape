...
namespace DrawShape.iOS
{
    public class ShapeRenderer : VisualElementRenderer<ShapeView>
    {
        ...
        protected CoreGraphics.CGRect AdjustForThickness(CoreGraphics.CGRect rect)
        {
        ...
        protected virtual void HandleShapeDraw(CGContext currentContext, CoreGraphics.CGRect rect)
        {
        ...
        protected virtual void HandleStandardDraw(CGContext currentContext, CoreGraphics.CGRect rect, Action createPathForShape, float? lineWidth = null)
        {
